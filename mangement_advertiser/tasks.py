...
def calculate_clicks_hour():
    ...
    Saver.objects.create(count=click_past_hour, type='click')
...
def calculate_views_hour():
    ...
    from .models import Saver
    Saver.objects.create(count=view_past_hour, type='view')
...
def calculate_clicks_days():
    ...
    Saver.objects.create(count=click_count, type='click')
...
def calculate_views_days():
    ...
    Saver.objects.create(count=view_count, type='view')
